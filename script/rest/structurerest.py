...
ARGUMENTS = {
    ...
    'stol': Argument('stol',
                     ...
                     store_missing=False,
                     help='Site tolerance'),
    'angle_tol': Argument('angle_tol',
                          type=float,
                          store_missing=False,
                          help='Angle tolerance in degrees'),
    'primitive_cell': Argument('primitive_cell',
                               type=bool,
                               store_missing=False,
                               help='Whether to reduce structures to primitive cells prior to matching'),
    'attempt_supercell': Argument('attempt_supercell',
                                  type=bool,
                                  store_missing=False,
    ...
    'allow_subset': Argument('allow_subset',
                             type=bool,
                             store_missing=False,
    ...
    'supercell_size': Argument('supercell_size',
                               type=str,
                               store_missing=False,
                               help='Method to use for determining the size of a supercell if applicable'),
    'ignored_species': Argument('ignored_species',
                                type=list,
                                store_missing=False,
...
def Soap_Fingerprints():
    ...
    args['atoms'] = [atoms_utils.from_structure_dict(
        s) for s in args.pop('structures')]
